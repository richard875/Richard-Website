...
export const RESUME_FILE = "Richard%20Everley%20Resume%20NN.pdf";
...
export const DESCRIPTION_EXPERIENCE = `${NAME} is a ${OCCUPATION} at FDJ UNITED (formerly Kindred Group), mastering JavaScript, React, AWS, and .NET, steering teams and innovating tech solutions.`;
